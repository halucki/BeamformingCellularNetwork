function [max_gain, max_idx, min_gain, min_idx, rand_gain, rand_idx, directivity, ArrayFactor, ArrayFactorRX, AF]=beamforming3c720(fc_MHz, angle,  M,  K, adjustedornot, fign)
...
% Developed in Matlab R2019b
    ...
    title("M="+string(M)+", K="+string(K)+": Beam Patterns");
    hold off
    ...
    maxtheta_deg=rad2deg(maxtheta_rad);
        ...
        for U_s=1:Sizeangle(1)
            ArrayFactorRX(:,U_s)=ArrayFactor(:, floorceil(angle(U_s,1), "f")+1);
        end
end
