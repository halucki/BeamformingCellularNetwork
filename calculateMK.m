function [SNRD_dBMK,SINRDlim_dBMK,C_UserDlimMK,C_CellDlimMK]=calculateMK(U, PL, Noise, Noise_dBm, fc_MHz, Ptx_dBm, U_store, rand_gainsi, htx, hrx, best_gains, rx_gains, rx_gainsi)
